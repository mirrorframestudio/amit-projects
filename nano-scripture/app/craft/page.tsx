...
export const metadata: Metadata = {
  title: 'הטכנולוגיה',
  description:
    'כיצד נצרבת ברכה שלמה על שטח של חצי מילימטר: ליתוגרפיית קרן יונים, בקרת איכות במיקרוסקופ אלקטרונים, ושיבוץ בתכשיט.',
};

const SPECS = [
  ['טכנולוגיית צריבה', 'ליתוגרפיית קרן יונים ממוקדת (FIB)'],
  ['עובי קו', '5 ננומטר · ±0.4'],
  ['שטח כתיבה', '0.5 מ״מ² (700 × 700 מיקרון)'],
  ['מצע', 'סיליקון מונו־קריסטלי'],
  ['חלון מגן', 'ספיר סינתטי, קשיות 9 מוס'],
  ['אטימה', 'הרמטית, עמידה במים בעומק 50 מטר'],
  ['אורך חיים צפוי', 'למעלה מ־100 שנה בתנאי לבישה רגילים'],
  ['בקרת איכות', 'סריקת SEM והשוואה תו־אחר־תו לנוסח המקור'],
];
...
const FAQ: QA[] = [
  ...
  },
  {
    ...
    a: 'אחרי הצריבה, כל שבב נסרק במיקרוסקופ אלקטרונים סורק, והתמונה מומרת חזרה לטקסט ומושווית אוטומטית לקובץ המקור - תו אחר תו. שבב עם ולו סטייה אחת נפסל ונגרס. שיעור הפסילה שלנו עומד על כ־8%.',
  },
  {
  ...
  },
  {
    ...
    a: 'הכתב אינו מודפס על פני השטח - הוא חרוט לתוך החומר. גם שריטה בזכוכית המגנה לא תפגע בטקסט. השבב אטום, עמיד למים, לזיעה ולתמרוקים.',
  },
  {
    q: 'כמה זמן לוקח לקבל את התכשיט?',
    a: 'השבב נצרב תוך 24 שעות מרגע ההזמנה, והחבילה מגיעה תוך 2-3 ימי עסקים.',
  },
  {
    q: 'מה כוללת האחריות?',
    a: 'שנתיים אחריות מלאה על השבב, השיבוץ והסוגר. החלפת שרשרת או תיקון סוגר - ללא עלות בתקופה הזו. נזק שנגרם משימוש חריג מטופל במחיר עלות בלבד.',
  },
];
    ...
    <>
      ...
      <section className="py-20">
        <div className="shell grid gap-10 border-y py-14 sm:grid-cols-3" style={{ borderColor: 'var(--line)' }}>
          {[
            { v: 5, l: 'ננומטר - עובי האות', s: '' },
            { v: 8, l: 'אחוז שבבים שנפסלים בבקרה', s: '%' },
            { v: 2, l: 'שעות צריבה לשבב יחיד', s: '' },
          ].map((s, i) => (
