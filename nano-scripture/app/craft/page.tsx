...
const FAQ: QA[] = [
  {
    ...
    a: 'לא בעין, וגם לא בזכוכית מגדלת רגילה. האות בגובה תשעה מיקרון, ונדרשת הגדלה של פי 500 לפחות - כלומר מיקרוסקופ. זו בדיוק הנקודה: הטקסט קיים שם במלואו, בין אם רואים אותו ובין אם לא. הזכוכית המגדלת שבאתר מראה איך זה נראה תחת הגדלה כזו.',
  },
  {
