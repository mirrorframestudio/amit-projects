...
export const metadata: Metadata = {
  title: 'הטכנולוגיה',
  description:
    'כיצד נצרבת ברכה שלמה על שטח של חצי מילימטר: ליתוגרפיית קרן יונים, בקרת איכות תו־אחר־תו, ושיבוץ בתכשיט.',
};
...
const FAQ: QA[] = [
  ...
  },
  {
    ...
    a: 'אחרי הצריבה, כל שבב נסרק במיקרוסקופ אלקטרונים סורק, והתמונה מומרת חזרה לטקסט ומושווית אוטומטית לקובץ המקור - תו אחר תו. שבב עם ולו סטייה אחת נפסל ונגרס ואינו יוצא מהמעבדה.',
  },
  {
