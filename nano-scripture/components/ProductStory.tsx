...
export default function ProductStory({
  ...
  const BLOCKS = [
    ...
    {
      title: 'שלושים וחמש אלפיות המילימטר',
      body: [
        `חלון הצריבה הוא ${CHIP_SPEC[0].value}, וכל הנוסח נכנס בתוכו.`,
        'גובה האות הוא כ־0.035 מ״מ, כמחצית מעובי שערת אדם. הכתב אינו מודפס אלא חרוט לתוך הזכוכית, ולכן בשימוש רגיל לא ידהה ולא יתחמצן.',
      ],
    },
    {
      title: 'הטקסט שם גם כשלא רואים אותו',
      body: [
        'את האותיות אי אפשר לראות בעין, וגם לא בזכוכית מגדלת רגילה. בגובה 0.035 מ״מ הן נקראות רק במיקרוסקופ.',
