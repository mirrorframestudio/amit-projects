...
export default function ProductStory({
  ...
  const BLOCKS = [
    ...
    },
    {
      ...
      body: [
        'האותיות בגובה תשעה מיקרון, ולכן אי אפשר לראות אותן בעין ולא בזכוכית מגדלת רגילה - נדרשת הגדלה של פי 500 לפחות.',
    ...
    },
    {
      ...
      body: [
        ...
        'הקופסה מרופדת ומגנה על התכשיט בדרך, ומגיעה מוכנה למסירה כמו שהיא.',
      ],
    },
  ];
