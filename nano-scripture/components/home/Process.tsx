...
const STEPS = [
  {
    n: '01',
    title: 'הכנת הפרוסה',
    body: 'פרוסת סיליקון מלוטשת עד לחספוס של פחות מננומטר אחד, ומצופה בשכבת זהב דקה. כל פגם ברמה האטומית יפסול את השבב בהמשך.',
  },
  {
    n: '02',
    title: 'צריבת הכתב',
    body: 'קרן יונים ממוקדת חורטת את הטקסט אות אחר אות, בעובי חמישה ננומטר. התהליך אורך כשעתיים לשבב, ומתבצע בחדר נקי בוואקום מלא.',
  },
  {
    n: '03',
    title: 'אימות ובקרה',
    body: 'מיקרוסקופ אלקטרונים סורק את השבב ומשווה אותו לנוסח המקור, תו אחר תו. שבב שסוטה ולו בתו אחד - נגרס.',
  },
  {
    n: '04',
    title: 'שיבוץ וגימור',
