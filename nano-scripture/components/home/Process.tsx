...
const STEPS = [
  {
    ...
    title: 'השבב',
    body: 'ריבוע זכוכית של 5 על 5 מ״מ. עליו נחרט הכתב, וכל השבבים זהים זה לזה.',
  },
  {
    title: 'צריבת הכתב',
    // "קרן יונים... בחדר נקי בוואקום מלא" - ללא מקור. המפעל: לייזר. חדר נקי - לא אושר
    body: 'קרן לייזר חורטת את הטקסט אות אחר אות, בגובה אות של כ־0.035 מ״מ.',
  },
  {
    title: 'אימות ובקרה',
  ...
  },
  {
    ...
    body: 'צורף משבץ את השבב בגוף התכשיט מתחת לחלון זכוכית, אוטם אותו, ומלטש את המתכת ביד.',
  },
];
